...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<BaseWebResponse> handleUserNotFoundExceptionException(@NotNull final UserNotFoundException exc) {
        log.error(exc.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new BaseWebResponse(createErrorMessage(exc)));
    }
    ...
    public ResponseEntity<BaseWebResponse> handleBookNotFoundExceptionException(@NotNull final BookNotFoundException exc) {
        log.error(exc.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new BaseWebResponse(createErrorMessage(exc)));
    }
